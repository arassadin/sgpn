...
parser.add_argument('--scan_path', default='/mnt/braxis_scannet/public/v2/scans/scene0644_00', help='path to scannet scene (e.g., data/ScanNet/v2/scene0000_00')
parser.add_argument('--output_file', default="gt_scene0644_00.txt", help='output file')
parser.add_argument('--label_map_file',default="/mnt/braxis_scannet/public/v2/tasks/scannetv2-labels.combined.tsv", help='path to scannetv2-labels.combined.tsv')
parser.add_argument('--type', default='instance', help='task type [label or instance]')
parser.add_argument('--label_map_file2',default="/mnt/raid/ji/3D_MASK_RCNN/datagen/fileLists/nyu40labels_scannet.csv")
...
def main():
    ...
    export(mesh_file, agg_file, seg_file, opt.label_map_file, opt.label_map_file2, opt.type, opt.output_file)
