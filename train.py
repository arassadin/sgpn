...
# Experiment Settings
parser.add_argument('--gpu', type=str, default="2", help='GPU to use [default: GPU 1]')
...
parser.add_argument('--batch', type=int, default=11, help='Batch Size during training [default: 4]')
